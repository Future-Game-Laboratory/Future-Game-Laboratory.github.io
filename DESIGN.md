...
- **Paper White `#FFFFFF`：** 全站唯一页面与界面表面。禁止用米白、灰白或深色主题替代。
- **Ink Black `#090909`：** 正文、边线与白色表面上的主要结构色。
...
- **Navigation：** 不显示 Home 项；点击左上角社团标识返回首页，其他栏目只显示全大写英文名称。移动端目录同样使用纯白背景。Edits 仅出现在移动端目录页脚，站点页脚不再重复任何导航入口。
